...
#import "QRPayHistoryViewController.h"
#import "QRPayHistoryCell.h"
#import "DetailPayRecordViewController.h"

static NSString * identiHisyCell = @"QRPayHistoryCell";

@interface QRPayHistoryViewController ()<UITableViewDelegate ,UITableViewDataSource>
...
@implementation QRPayHistoryViewController
- (void)viewDidLoad {
    [super viewDidLoad];

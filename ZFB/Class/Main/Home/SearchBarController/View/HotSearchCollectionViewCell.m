...
- (UICollectionViewLayoutAttributes *)preferredLayoutAttributesFittingAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes{
    ...
    CGRect frame = [self.hotTitle.text boundingRectWithSize:CGSizeMake(CGFLOAT_MAX, self.hotTitle.frame.size.height) options:(NSStringDrawingUsesLineFragmentOrigin) attributes:[NSDictionary dictionaryWithObjectsAndKeys:self.hotTitle.font,NSFontAttributeName, nil] context:nil];

...
#import "CouponTableView.h" //领取优惠券
#import "SDCycleScrollView.h"

@interface DetailStoreViewController ()<SDCycleScrollViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout ,CouponTableViewDelegate>
{
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        if (kind == UICollectionElementKindSectionHeader) {
            UICollectionReusableView * sectionView = [[UICollectionReusableView alloc]initWithFrame:CGRectMake(0, 0, KScreenW, 44)];

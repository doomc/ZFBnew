...
{
    _cacuList = cacuList;
    _lb_amount.text = [NSString stringWithFormat:@"结算金额:  ¥%@",cacuList.settlement_store_amount];
    _lb_orderPrice.text = [NSString stringWithFormat:@"订单金额:  ¥%@",cacuList.order_amount];
...
{
    _sendList = sendList;
    _lb_amount.text = [NSString stringWithFormat:@"结算金额:  ¥%@",sendList.settlement_delivery_amount];
    _lb_orderPrice.text = [NSString stringWithFormat:@"订单金额:  ¥%@",sendList.order_amount];

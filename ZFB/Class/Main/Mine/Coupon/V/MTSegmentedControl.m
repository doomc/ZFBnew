...
//            bottomLayer.frame = CGRectMake(i * witdthFloat+witdthFloat/8*3, self.bounds.size.height - 8, witdthFloat/2, 2);
...
-(void)selectTheSegument:(NSInteger)segument{
    ...
    if (_selectSeugment != segument) {
        ...
        if (self.isAnimated) {
            ...
            [bottomLayer setFrame:CGRectMake(segument * witdthFloat+witdthFloat/8*3,self.bounds.size.height - 8, witdthFloat/4, 2)];
        } else {

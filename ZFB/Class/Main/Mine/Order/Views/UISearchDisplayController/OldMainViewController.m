...
- (void)initMapView
{
    _mapView = [[MAMapView alloc] initWithFrame:CGRectMake(0,0, KScreenW, KScreenH - CELL_HEIGHT*CELL_COUNT)];
...
- (void)initTableView
{
    _tableView = [[MapPoiTableView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_mapView.frame)-64, KScreenW, CELL_HEIGHT*CELL_COUNT + 64)];

...
- (void)makeToastActivity:(id)position {
    ...
    UIView *activityView = [[[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height)] autorelease];
    ...
    //activityView.backgroundColor = [[UIColor colorWithRed:130/255.0 green:170/255.0 blue:170/255.0 alpha:1.0] colorWithAlphaComponent:CSToastOpacity];
     activityView.backgroundColor = [UIColor colorWithRed:237.0/255 green:238.0/255 blue:239.0/255 alpha:0.5];
